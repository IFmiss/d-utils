 ...
 * 通用工具类
 */
var GenericUtils = /** @class */ (function () {
     ...
     */
    GenericUtils.notification = function (options) {
        var defaultV = {
            title: '未曾遗忘的青春',
            body: 'Hello World !!!',
        ...
        var newOpt = Object.assign({}, defaultV, options);
     ...
     * console(color)
     */
    GenericUtils.randomColor = function (opacity) {
     ...
     */
    GenericUtils.layoutFramework = function () {
     ...
     */
    GenericUtils.calcStringLength = function (str, isStrict) {
        if (typeof str !== 'string') {
            index_1.default.logError("str must be string but found " + typeof str, 'GenericUtils.calcStringLength => error');
            return;
        }
        if (!isStrict)
            return str.length;
        ...
        for (var i = 0; i < str.length; i++) {
            var count = str.charCodeAt(i) > 255 ? 2 : 1;
            a += count;
        }
        return a;
    };
     ...
     */
    GenericUtils.strTrim = function (str, type) {
        if (type === void 0) { type = 0; }
        if (typeof str !== 'string') {
            index_1.default.logError("str must be string but found " + typeof str, 'GenericUtils.strTrim => error');
            return;
        }
        switch (type) {
            case 0:
     ...
     * }, 1000)
     */
    GenericUtils.throttle = function (fn, t) {
        if (t === void 0) { t = 1000; }
        if (typeof fn !== 'function') {
            index_1.default.logError("\u7B2C\u4E00\u4E2A\u53C2\u6570\u5FC5\u987B\u662F\u65B9\u6CD5", 'GenericUtils.throttle => error');
            return;
        }
        var _fn = fn;
        var time = null;
     ...
     * }, 1000)
     */
    GenericUtils.debounce = function (fn, t, immediate) {
        if (immediate === void 0) { immediate = true; }
        if (typeof fn !== 'function') {
            index_1.default.logError("\u7B2C\u4E00\u4E2A\u53C2\u6570\u5FC5\u987B\u662F\u65B9\u6CD5", 'GenericUtils.debounce => error');
            return;
        }
        var time;
        //  立刻执行第一次该方法
     ...
     */
    GenericUtils.formatDate = function (fmt, date) {
     ...
     */
    GenericUtils.copyCode = function (str) {
     ...
     */
    GenericUtils.openFullScreen = function (ele) {
     ...
     */
    GenericUtils.exitFullScreen = function () {
