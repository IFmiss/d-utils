...
class ImageUtils {
    ...
    loadResourse(src, resourse) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Promise((resolve, reject) => {
                ...
                image.onerror = () => {
                    index_1.default.logError(src, '[d-utils] ImageUtils loadResourse 裁剪图片加载错误');
                    reject();
                };
            });
        });
    ...
    convertCanvasToImage() {
        ...
        index_1.default.logSuccess(image, '[d-utils] ImageUtils convertCanvasToImage 图片对象创建成功');
        return image;
    }
}
