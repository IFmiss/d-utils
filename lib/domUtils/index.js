...
class DomUtils {
     ...
     */
    static computedStyle(el, cssProp) {
        if (!el) {
            index_1.default.logError('dom元素不存在', '[d-utils] DomUtils computedStyle error => ');
            return;
        }
        if (!cssProp) {
            index_1.default.logError('请输入需要查询的css属性名称', '[d-utils] DomUtils computedStyle error => ');
            return;
        }
     ...
     * })
     */
    static cssFilter(el, type, option) {
