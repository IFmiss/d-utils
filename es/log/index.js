...
class Log {
     ...
     */
    static console(data, dataTitile = '数据信息', color = Log.defaultColor) {
        if (isObject(data)) {
     ...
     */
    static group(dataTitile = '[d-utils] log_utils group => ', color = Log.defaultColor) {
        console.group(`%c${dataTitile}`, `color: ${color}; font-weight: bold`);
    }
    /**
     * log打印一个group组  折叠的
     */
    static groupCollapsed(dataTitile = '[d-utils] log_utils group_collapsed => ', color = Log.defaultColor) {
 ...
 * 提示色  '#9E9E9E'   默认灰色
 */
Log.defaultColor = '#9E9E9E';
/**
 * 提示色  '#0099FF'   蓝色
 */
Log.infoColor = '#0099FF';
/**
 * 提示色  '#00CC99'   绿色
 */
Log.successColor = '#00CC99';
/**
 * 提示色  '#CC3366'   红色
 */
Log.errorColor = '#CC0000';
/**
 * 提示色  '#CC9966'   黄色
 */
Log.warningColor = '#FF9966';
export default Log;
